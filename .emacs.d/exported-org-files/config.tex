...
\label{sec:orgeeb8a2a}
Automatically pair the following elements on autocorrect. This is enabled in the \hyperref[sec:org6e95e50]{Standards (minor modes and minor improvements)} through electric-pair-mode.
...
\end{verbatim}
\subsection{Buffers}
\label{sec:orga6b2d14}
All things buffer related
\subsubsection{Buffer-move}
\label{sec:org2a37062}
Be able to swap buffers. See \hyperref[sec:org63af768]{Custom keystrokes} for shortcuts (buf-move-xxx).
\begin{verbatim}
(use-package buffer-move
  :ensure t)
\end{verbatim}
\subsubsection{Ibuffer}
\label{sec:orge9a4eb5}
...
\label{sec:orgec3d13f}
\begin{enumerate}
\item Always kill current buffer
\label{sec:orgcd7eb49}
\begin{verbatim}
(global-set-key (kbd "C-x k") 'kill-current-buffer)
\end{verbatim}
\item Kill all buffers
\label{sec:org1d7ece0}
\begin{verbatim}
